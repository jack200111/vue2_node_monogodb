  ...
  <el-container style="height: 100vh;">
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
      <el-menu router :default-openeds="['1']" unique-opened :default-active="$route.path">
         <el-submenu index="0">
          <template slot="title">
            <i class="el-icon-message"></i>GPT3.5
          </template>
          <el-menu-item-group>
            <template slot="title">首页</template>
            <el-menu-item index="/home/index">问答</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        <!-- 内容管理 -->
        <el-submenu index="1">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="/items/create">添加图片</el-menu-item>
            <el-menu-item index="/items/list">图片列表</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group>
            <template slot="title">人员</template>
            <el-menu-item index="/heroes/create">添加人员</el-menu-item>
            <el-menu-item index="/heroes/list">人员列表</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group>
        ...
        <el-submenu index="2">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="/ads/create">添加广告位</el-menu-item>
        ...
        <el-submenu index="3">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="/categories/create">添加分类</el-menu-item>
